    ...
    while True:
        ...
        if guess in secret_word and guess not in letters_guessed:
            ...
            if is_word_guessed(secret_word, letters_guessed):
                ...
                print("Your total score for this game is: " + str(guesses * len(letters_guessed)))
                break
        
        else:
            message = "Oops! "
            if not guess.isalpha():
                message += "That is not a valid letter. "
            ...
            if not guess.isalpha() or guess in letters_guessed:
                ...
                if warnings > 0:
                    warnings -= 1
                    message += str(warnings) + " warnings left"
                else:
                    guesses -= 1
                    message += str(guesses) + " no warnings left so you lose one guess"
                message += ": " + get_guessed_word(secret_word, letters_guessed)
                print(message)
            else:
                letters_guessed += guess
                message += "That letter is not in my word: " + get_guessed_word(secret_word, letters_guessed)
                print(message)
                if guess in "aeiou":
                    guesses -= 2
                else:
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    while True:
        ...
        if guess in secret_word and guess not in letters_guessed:
            ...
            elif not guess.isalpha() or guess in letters_guessed:
                message += "You have "
                if warnings > 0:
                    warnings -= 1
                    message += str(warnings) + " warnings left"
